...
static const u32_t GPIO_NVICInterruptNum[Port_Indices]={0,1,2,3,4,30};
...
void static inline GPIO_EnableRunModeClockGateControl2(GPIO_PortNumIndexArr_t PortNumIndexArr){
    RunModeClockGatingControlRegister2->Bits.GPIOPortRunModeClockGatingControl |= (1<<PortNumIndexArr);
    while( (RunModeClockGatingControlRegister2->Bits.GPIOPortRunModeClockGatingControl & (1<<PortNumIndexArr)) == 0);
...
void GPIO_ConfigureInputPin(GPIO_ConfigurePin_t* pt_ConfigurePin){
    ...
    GPIO_SetPinStatus(pt_ConfigurePin->PortNumIndexArr, pt_ConfigurePin->ConfigureChannelNum , Input);
...
/**********************End of BitBand Functions ***********************************************/




/*******************************************************************************************/
/*                         Alternative Function (AFSEL)                                    */
/*******************************************************************************************/
...
void GPIO_EnableAFSEL_CAN(GPIO_CANConfigChannel_t* pt_CANConfigChannel){

    GPIO_EnableRunModeClockGateControl2(pt_CANConfigChannel->PortNumIndexArr);

    GPIO_ConfigureAlternateFunctionSelect(pt_CANConfigChannel->PortNumIndexArr, pt_CANConfigChannel->ChannelNumRx,Enable_AFSEL); // U0RX
    GPIO_ConfigureAlternateFunctionSelect(pt_CANConfigChannel->PortNumIndexArr, pt_CANConfigChannel->ChannelNumTx,Enable_AFSEL); // U0TX

    GPIO_ConfigurePortControl(pt_CANConfigChannel->PortNumIndexArr,pt_CANConfigChannel->ChannelNumRx,MuxValue_1);
    GPIO_ConfigurePortControl(pt_CANConfigChannel->PortNumIndexArr,pt_CANConfigChannel->ChannelNumTx,MuxValue_1);

    GPIO_ConfigureDigitalEnable(pt_CANConfigChannel->PortNumIndexArr, pt_CANConfigChannel->ChannelNumRx, EnableDigitalFunction);
    GPIO_ConfigureDigitalEnable(pt_CANConfigChannel->PortNumIndexArr, pt_CANConfigChannel->ChannelNumTx, EnableDigitalFunction);

}
/**********************End of Alternative Function select ***********************************************/
...
void GPIO_ConfigureInterruptSource(GPIO_InterruptSourceIndexArr_t InterruptSourceIndexArr,GPIO_PortNumIndexArr_t PortNumIndexArr, GPIO_ConfigureChannelNum_t ConfigureChannelNum ){

    /***********************CONFIG SOURCE***********************************/
    /*1- */
    switch (GPIO_InterruptSource_ArrPtrStruct[InterruptSourceIndexArr]->ConfigInterruptSense){

      case EdgeSensitive:
        GPIO_InterruptSense_Registers[PortNumIndexArr]->Bits.Interrupt_Sence &=~(1<<ConfigureChannelNum);
        break;
      case LevelSensitive:
        GPIO_InterruptSense_Registers[PortNumIndexArr]->Bits.Interrupt_Sence |=(1<<ConfigureChannelNum);
        break;
    ...
    switch (GPIO_InterruptSource_ArrPtrStruct[InterruptSourceIndexArr]->ConfigInterruptBothEdges){

      case OneEdgeSensitive:
          GPIO_InterruptBothEdges_Registers[PortNumIndexArr]->Bits.InterruptBothEdges &=~(1<<ConfigureChannelNum);
        break;
      case BothEdgeSensitive:
          GPIO_InterruptBothEdges_Registers[PortNumIndexArr]->Bits.InterruptBothEdges |=(1<<ConfigureChannelNum);
        break;
    }

    switch (GPIO_InterruptSource_ArrPtrStruct[InterruptSourceIndexArr]->ConfigInterruptEvent){
      case FallingEdge_OR_LowLevel:
          GPIO_InterruptEvent_Registers[PortNumIndexArr]->Bits.InterruptEvent &=~(1<<ConfigureChannelNum);
        break;
      case RisingEdge_OR_HighLevel:
          GPIO_InterruptEvent_Registers[PortNumIndexArr]->Bits.InterruptEvent |=(1<<ConfigureChannelNum);
        break;
    }
    ...
    GPIO_ConfigureInterruptMask(PortNumIndexArr, ConfigureChannelNum, Enable_InterruptMask);
    NVIC_Enable_Interrupt(GPIO_NVICInterruptNum[PortNumIndexArr]);
