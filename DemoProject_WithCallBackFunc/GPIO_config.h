...
typedef enum{
    EdgeSensitive,
    LevelSensitive
}GPIO_ConfigInterruptSense_t;
/***********************************/

typedef enum{
    OneEdgeSensitive,
    BothEdgeSensitive
}GPIO_ConfigInterruptBothEdges_t;
/***********************************/

typedef enum{
    FallingEdge_OR_LowLevel,
    RisingEdge_OR_HighLevel
}GPIO_ConfigInterruptEvent_t;
/***********************************/
...
typedef enum{
   ...
   RisingLevel,
   FallingLevel
}GPIO_InterruptSourceIndexArr_t;
...
typedef struct{
 ...
 typedef struct{
     GPIO_ConfigInterruptSense_t ConfigInterruptSense;
     GPIO_ConfigInterruptBothEdges_t ConfigInterruptBothEdges;
     GPIO_ConfigInterruptEvent_t ConfigInterruptEvent;
 }GPIO_InterruptSourceStruct_t;
 /***********************************/
...
extern GPIO_CANConfigChannel_t* const GPIO_CAN_AFSELConfig_ArrPtrStruct[2];
...
extern GPIO_InterruptSourceStruct_t* const GPIO_InterruptSource_ArrPtrStruct[4];
