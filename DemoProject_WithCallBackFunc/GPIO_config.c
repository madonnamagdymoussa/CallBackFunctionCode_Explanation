...
/*==================================================*/
/*     Config for  AFSEL_CAN                       */
/*==================================================*/

GPIO_CANConfigChannel_t CAN0_AFSELConfig={
 PortE,
 Channel_4,
 Channel_5
};

GPIO_CANConfigChannel_t CAN1_AFSELConfig={
 PortA,
 Channel_0,
 Channel_1
};
...
GPIO_ConfigurePin_t GPIO_ConfigurePin_PF4={
 ...
 /********************InterruptSource*********************/
 GPIO_InterruptSourceStruct_t InterruptSourceRisingEdge={
     EdgeSensitive,
     OneEdgeSensitive,
     RisingEdge_OR_HighLevel
 };
 GPIO_InterruptSourceStruct_t InterruptSourceFallingEdge={
     EdgeSensitive,
     OneEdgeSensitive,
     FallingEdge_OR_LowLevel
 };

 GPIO_InterruptSourceStruct_t InterruptSourceRisingLevel={
     LevelSensitive,
     OneEdgeSensitive,
     RisingEdge_OR_HighLevel
 };

 GPIO_InterruptSourceStruct_t InterruptSourceFallingLevel={
     LevelSensitive,
     OneEdgeSensitive,
     FallingEdge_OR_LowLevel
 };
...
GPIO_InterruptSourceStruct_t* const GPIO_InterruptSource_ArrPtrStruct[4]={
&InterruptSourceRisingEdge,
&InterruptSourceFallingEdge,
&InterruptSourceRisingLevel,
&InterruptSourceFallingLevel
};

GPIO_CANConfigChannel_t* const GPIO_CAN_AFSELConfig_ArrPtrStruct[2]={
&CAN0_AFSELConfig,
&CAN1_AFSELConfig
};
