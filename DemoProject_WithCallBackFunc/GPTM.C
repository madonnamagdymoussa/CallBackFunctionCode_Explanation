...
static volatile  CallbackFunc_t GPTM_Callback_WideSubTimer0A=NULL_PTR;
static volatile  CallbackFunc_t GPTM_Callback_WideSubTimer0B=NULL_PTR;
static volatile  CallbackFunc_t GPTM_Callback_WideSubTimer1A=NULL_PTR;
static volatile  CallbackFunc_t GPTM_Callback_WideSubTimer1B=NULL_PTR;
...
volatile GPTMIMR_Reg static *const GPTM_IMRRegisters[TimerSize_Indices][TimerChannel_Indices]={

    {
       (GPTMIMR_Reg*)GPTM_16_32BitTimer0IMR,
       (GPTMIMR_Reg*)GPTM_16_32BitTimer1IMR,
       (GPTMIMR_Reg*)GPTM_16_32BitTimer2IMR,
       (GPTMIMR_Reg*)GPTM_16_32BitTimer3IMR,
       (GPTMIMR_Reg*)GPTM_16_32BitTimer4IMR,
       (GPTMIMR_Reg*)GPTM_16_32BitTimer5IMR
    },

    {
       (GPTMIMR_Reg*)GPTM_32_64BitTimer0IMR,
       (GPTMIMR_Reg*)GPTM_32_64BitTimer1IMR,
       (GPTMIMR_Reg*)GPTM_32_64BitTimer2IMR,
       (GPTMIMR_Reg*)GPTM_32_64BitTimer3IMR,
       (GPTMIMR_Reg*)GPTM_32_64BitTimer4IMR,
       (GPTMIMR_Reg*)GPTM_32_64BitTimer5IMR
       }
 ...
 void GPTM_WideSubTimer0A_Handler(void){
     ...
     if (GPTM_Callback_WideSubTimer0A != NULL_PTR){

          (*GPTM_Callback_WideSubTimer0A)();
         }

  }

void GPTM_RegisterCallbackFunction(CallbackFunc_t pt_func){

     GPTM_Callback_WideSubTimer0A=pt_func;
 }


  void GPTM_WideSubTimer0B_Handler(void){

 }
 void GPTM_WideSubTimer1A_Handler(void){

 }
 void GPTM_WideSubTimer1B_Handler(void){
...
void GPTM_GenerateDelay_Interrupt(GPTM_ConfigurationChannel_t* pt_TimerConfigChannel, u32_t NumDelayUnit, GPTM_DelayUnit_t DelayUnit){

    //NVIC_Enable_SubTimerA();
    u64_t SystemClkFreq;
    u32_t TimerOnTickNum;
    ...
    //*((u32_t *)GPTM_32_64_BitTimerA_IntervalLoad[pt_TimerConfigChannel->ChannelIndexArr])=_32Bit_TotalTickNum-(_32Bit_TotalTickNum-TimerOnTickNum);
    *((u32_t *)GPTM_32_64_BitTimerA_Match[pt_TimerConfigChannel->ChannelIndexArr])=0;
    *((u32_t *)GPTM_32_64_BitTimerA_IntervalLoad[pt_TimerConfigChannel->ChannelIndexArr])=16000000;

    GPTM_IMRRegisters[pt_TimerConfigChannel->TimerSizeNameIndexArr][pt_TimerConfigChannel->ChannelIndexArr]->bits.TATOIM=1;

    GPTM_ICRRegisters[pt_TimerConfigChannel->TimerSizeNameIndexArr][pt_TimerConfigChannel->ChannelIndexArr]->bits.TATOCINT=1;

    NVIC_Enable_Interrupt(94);
...
void GPTM_WideSubTimerA_ClearInterrupt(void){
    GPTM_ICRRegisters[_32_64BitTimerA][Timer0]->bits.TATOCINT=1;
